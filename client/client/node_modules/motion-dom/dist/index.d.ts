...
type StartAnimation = (complete: () => void) => AnimationPlaybackControls | undefined;
...
declare class ViewTransitionBuilder {
    ...
    notifyReady: (value: BaseGroupPlaybackControls) => void;
